...
class currentCase:
    def __init__(self,name,dateTime,lowest_price,volume,median_price,url):
        self.name = name
        self.dateTime = dateTime
        self.lowest_price = lowest_price
        self.volume = volume
...
caseList = ["CSGO Weapon Case", "Operation Bravo Case", "CSGO Weapon Case 2", "Winter Offensive Weapon Case", "CSGO Weapon Case 3", "Operation Phoenix Case", "Huntsman Case", "Operation Breakout Case", "Operation Vanguard Case", "Chroma Case", "Chroma 2 Case", "Falchion Case", "Shadow Case", "Revolver Case", "Operation Wildfire Case", "Chroma 3 Case", "Gamma Case", "Gamma 2 Case", "Glove Case", "Spectrum Case", "Operation Hydra Case", "Spectrum 2 Case", "Clutch Case", "Horizon Case", "Danger Zone Case", "Prisma Case", "CS20 Case", "Operation Shattered Web Case", "Prisma 2 Case", "Fracture Case", "Operation Broken Fang Case", "Snakebite Case", "Operation Riptide Case", "Dreams and Nightmares Case" ,"Recoil Case"]
